...
class _WeSlideState extends State<WeSlide> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _panelWidth = Tween<double>(begin: 0, end: 20).animate(_ac);
                  ...
                  child: _ac.value == 0.0
                      ...
                      : InkWell(
                          child: Container(
                            ...
                            color: widget.blurColor.withAlpha(10),
                          ),
                          onTap: () {
          ...
          AnimatedBuilder(
                  ...
                  child: AnimatedContainer(
                    ...
                    child: ClipRRect(
                      borderRadius: BorderRadius.only(
                        ...
                        bottomLeft: Radius.circular(_panelborderRadius.value),
                        bottomRight: Radius.circular(_panelborderRadius.value),
                      ),
                      child: child,
                    ),
                  ),
            ...
            child: Stack(
              children: <Widget>[
                ...
                widget.panelHeader != null && !widget.hidePanelHeader ? widget.panelHeader : SizedBox.shrink(),
              ],
            ),
          ),
          // Footer Widget
